...
import useCreateAntonym from './useCreateAntonym.ts'
import useDeleteAntonym from './useDeleteAntonym.ts'
import useCreateSynonym from './useCreateSynonym.ts'
import useDeleteSynonym from './useDeleteSynonym.ts'
